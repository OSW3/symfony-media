...
return static function($definition)
{
    $definition->rootNode()->children()
        ...
        ->append( (include __DIR__."/parts/storages.php")() )
        ->append( (include __DIR__."/parts/presets.php")() )
        ->append( (include __DIR__."/parts/providers.php")() )
        ->append( (include __DIR__."/parts/subscribers.php")() )
